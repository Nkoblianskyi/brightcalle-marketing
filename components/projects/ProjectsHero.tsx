    ...
    <section className="relative py-20 md:py-28 bg-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Nuestros <span className="text-yellow-500">Proyectos</span>
          </motion.h1>
          ...
          >
            ...
            impacto. Cada proyecto es una historia de éxito que demuestra nuestra capacidad para transformar espacios
            urbanos en poderosas herramientas de comunicación.
          </motion.p>
