      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
            ¿Listo para <span className="text-yellow-500">Crear</span> tu Próximo Proyecto?
          </h2>

          <p className="text-xl text-gray-300 mb-10 leading-relaxed">
            Descubre cómo podemos ayudarte a destacar en el entorno urbano con campañas de marketing offline que generen
            un impacto real y resultados tangibles.
          </p>
